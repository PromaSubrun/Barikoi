...
public class TC_01CheckSearchFunctionalityWithInvalidValue extends DriverSetup{
	...
	public static void Barikoi() throws InterruptedException {
		...
		driver.findElement(By.xpath("//body/div[@id='root']/div[1]/div[1]/div[1]/div[2]/div[1]/form[1]/div[1]/input[1]")).sendKeys("%%%%%%");
		Thread.sleep(5000);
